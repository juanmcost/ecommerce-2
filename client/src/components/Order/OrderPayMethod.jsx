import { Flex, Box, Stack, Heading, useColorModeValue, RadioGroup, Radio, Image } from '@chakra-ui/react'; // import chackra
import { useState } from 'react';
import cardIcons from '../../assets/cardIcons.png';
import paypalIcon from '../../assets/logo-Paypal.png';
import mercadoPago from '../../assets/mercadoPago.png';
import RenderCardForm from '../../common/Order/CreditCardForm';
import RenderPayPalForm from '../../common/Order/PayPalForm';
import RenderMercadoPagoForm from '../../common/Order/MercadoPagoForm';
    ...
    return (
        <Flex minH={'100vh'} align={'center'} justify={'center'} bg={useColorModeValue('gray.50', 'gray.800')}>
            <Stack spacing={8} mx={'auto'} maxW={'1g'} py={12} px={6} align={'center'}>
                ...
                <Box w="50%" rounded={'lg'} bg={useColorModeValue('white', 'gray.700')} boxShadow={'lg'} p={8}>
                    <Stack spacing={4}>
