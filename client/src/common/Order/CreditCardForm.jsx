import { Stack, Button, FormControl, FormLabel, Input, FormHelperText } from '@chakra-ui/react'; // import chackra
        ...
        <form onSubmit={(e) => handleSubmit(e)}>
            <Stack>
                ...
                <FormControl id="cardName" isRequired>
                    ...
                    <Input name="cardName" placeholder="John Snow" onChange={(e) => handleCardInput(e)} type="text" />
                </FormControl>
                <Stack direction={{ base: 'column', sm: 'row' }} align={'start'} justify={'space-between'}>
                    <FormControl id="expiryDate" isRequired>
                        <FormLabel>Expiry Date</FormLabel>
                        <Input name="expiryDate" placeholder="07/10" onChange={(e) => handleCardInput(e)} type="date" />
                    </FormControl>
