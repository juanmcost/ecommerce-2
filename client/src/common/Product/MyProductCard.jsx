...
import { Flex, GridItem, Stack, SimpleGrid, Text, useColorModeValue } from '@chakra-ui/react';
...
export const MyProductCard = ({ product }) => {
    ...
    return (
        <Flex rounded={13} boxShadow={themer('lg', 'dark-lg')} bg={themer('white', 'gray.800')}>
            <Flex align="center" direction={{ base: 'row', md: 'column' }}>
                <SimpleGrid spacingY={3} columns={{ base: 1, md: 4 }} w="full" py={2} px="3vw" fontWeight="hairline">
